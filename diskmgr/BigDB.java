...
public class BigDB implements GlobalConst {
   ...
   * @exception IOException                I/O errors
   */
  public void read_page(PageId pageno, Page apage) throws InvalidPageNumberException, FileIOException, IOException {
   ...
   * @exception IOException                I/O errors
   */
  public void write_page(PageId pageno, Page apage) throws InvalidPageNumberException, FileIOException, IOException {
   ...
   * @exception DiskMgrException           error caused by other layers
   */
  public void allocate_page(PageId start_page_num) throws OutOfSpaceException, InvalidRunSizeException,
   ...
   * @exception DiskMgrException           error caused by other layers
   */
  public void allocate_page(PageId start_page_num, int runsize) throws OutOfSpaceException, InvalidRunSizeException,
      InvalidPageNumberException, FileIOException, DiskMgrException, IOException {
  ...
  public void add_file_entry(String fname, PageId start_page_num)
      throws FileNameTooLongException, InvalidPageNumberException, InvalidRunSizeException, DuplicateEntryException,
  ...
  public void delete_file_entry(String fname)
      throws FileEntryNotFoundException, IOException, FileIOException, InvalidPageNumberException, DiskMgrException {
...
class DBHeaderPage implements PageUsedBytes, GlobalConst {
  ...
  public void setNextPage(PageId pageno) throws IOException {
    ConvertMap.setIntValue(pageno.pid, NEXT_PAGE, data);
  }
  ...
  protected void setNumOfEntries(int numEntries) throws IOException {
    ConvertMap.setIntValue(numEntries, NUM_OF_ENTRIES, data);
  }
  ...
  public int getNumOfEntries() throws IOException {
    return ConvertMap.getIntValue(NUM_OF_ENTRIES, data);
  }
  ...
  private void initFileEntry(int empty, int entryNo) throws IOException {
    ...
    ConvertMap.setIntValue(empty, position, data);
  }
  ...
  public void setFileEntry(PageId pageNo, String fname, int entryNo) throws IOException {
    ...
    int position = START_FILE_ENTRIES + entryNo * SIZE_OF_FILE_ENTRY;
    ConvertMap.setIntValue(pageNo.pid, position, data);
    ConvertMap.setStrValue(fname, position + 4, data);
  }
...
class DBFirstPage extends DBHeaderPage {
  ...
  public void setNumDBPages(int num) throws IOException {
    ConvertMap.setIntValue(num, NUM_DB_PAGE, data);
  }
  ...
  public int getNumDBPages() throws IOException {
    ...
    return (ConvertMap.getIntValue(NUM_DB_PAGE, data));
  }
