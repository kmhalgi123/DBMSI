...
public class SortMerge extends Iterator implements GlobalConst {
	...
	/**
	 * The tuple is returned All this function has to do is to get 1 tuple from one
	 * of the Iterators (from both initially), use the sorting order to determine
	 * which one gets sent up. Amit) Hmmm it seems that some thing more has to be
	 * done in order to account for duplicates.... => I am following Raghu's 564
	 * notes in order to obtain an algorithm for this merging. Some funda about
	 * "equivalence classes"
	 * 
