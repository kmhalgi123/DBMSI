...
public class IndexScan extends Iterator {
	   ...
	   IOException
  {
	...
	if (_types[_fldNum -1].attrType == AttrType.attrInteger) {
	  ...
	  try {
	    Jtuple.setTimeStamp(((IntegerKey)nextentry.key).getKey().intValue());
	  }
	  catch (Exception e) {
	    throw new IndexException(e, "IndexScan.java: Heapfile error");
	  }	  
	...
	throw new IndexException(e, "IndexScan.java: Heapfile error");
      ...
      boolean eval;
      try {
	eval = PredEval.Eval(_selects, tuple1,   null);
      }
      catch (Exception e) {
	throw new IndexException(e, "IndexScan.java: Heapfile error");
      }
